...
classdef p53CinemaManual_object_cellTracker < handle
    ...
    methods
        ...
        function obj = p53CinemaManual_object_cellTracker(master)
            ...
            obj.centroidsCustom = CentroidTimeseries(master.obj_fileManager.maxTimepoint, 10000);
            obj.master = master;
        ...
        function [] = setCustomEvent(obj)
            centroid = obj.centroidsTracks.getCentroid(obj.master.obj_imageViewer.currentTimepoint, obj.master.obj_imageViewer.selectedCell);
            if(centroid(1) > 0)
                obj.centroidsCustom.setCentroid(obj.master.obj_imageViewer.currentTimepoint, obj.master.obj_imageViewer.selectedCell, centroid, 1);
                obj.centroidsTracks.setCentroid(obj.master.obj_imageViewer.currentTimepoint, obj.master.obj_imageViewer.selectedCell, centroid, 1);
            end
        end
        ...
        function deleteCellTimepoints(obj, cell_id, timepoints)
            for i=timepoints
                ...
                obj.centroidsCustom.setCentroid(i, cell_id, [0,0], 0);
        ...
        function replaceCellTimepoints(obj, sourceCell, targetCell, timepoints)
            for i=timepoints
                ...
                obj.centroidsCustom.setCentroid(i, targetCell, obj.centroidsCustom.getCentroid(i, sourceCell), obj.centroidsCustom.getValue(i, sourceCell));
            end
        end
