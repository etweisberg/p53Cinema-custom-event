...
%             end
            ...
            [customCentroids, customCells] = obj.obj_cellTracker.centroidsCustom.getCentroids(obj.currentTimepoint);
            ...
            set(handles.customEventPatch, 'XData', customCentroids(:,2), 'YData', customCentroids(:,1));
            ...
            if(obj.selectedCell)
                ...
                customCell = any(obj.obj_cellTracker.centroidsCustom.getCentroid(obj.currentTimepoint, obj.selectedCell) > 0);
                ...
                if(~dividingCell && ~deathCell && ~customCell)
                    ...
                    if(~isempty(targetNeighbor))
                        ...
                        customCell = any(obj.obj_cellTracker.centroidsCustom.getCentroid(obj.currentTimepoint, neighborCell) > 0);
